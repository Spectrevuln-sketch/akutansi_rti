<div class="main-header">
  ...
  <div class="logo-header" data-background-color="blue">
    ...
    <a href="index.html" class="logo" style="margin-left: -10%;">
      <img src="<?= base_url('assets/'); ?>img/logo.svg" alt="navbar brand" class="navbar-brand">
      <h6 class="d-inline text-light" style="margin-left: -5%;">RTI Billing Admin</h6>
    </a>
      ...
      <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
        ...
        <li class="nav-item dropdown hidden-caret">
          <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
            <div class="avatar-sm">
              <i class="fas fa-user fa-fw mt-2 ml-2" style="color: azure; font-size: 20px;"></i>
            </div>
          </a>
          <ul class="dropdown-menu dropdown-user animated fadeIn">
            <div class="dropdown-user-scroll scrollbar-outer">
              <li>
                <div class="user-box">
                  <i class="fas fa-user fa-fw mt-2 ml-1" style="color: black; font-size: 20px;"></i>
                  <div class="u-text">
